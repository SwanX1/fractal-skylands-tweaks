...
public class FSTIslandConfigurations {
    ...
    public static IslandConfiguration START_ISLAND = new IslandConfiguration(
        new IslandTerrainSettings(14, 0.0625, 0.5, 1, 0, 0.0625, 0.9),
        StartIsland::new
    )
        .withMinDistance(256)
        .withAltitude(120)
    ...
    public static IslandConfiguration SOME_BIGGER_ISLAND = new IslandConfiguration(
        new IslandTerrainSettings(8, 0.0625, 0.5, 1, 0, 0.0625, 0.7),
        StartIsland::new
    )
        .withMinDistance(128)
        .withAltitude(80)
    ...
    public static IslandConfiguration EXAMPLE_ISLAND = new IslandConfiguration(
        new IslandTerrainSettings(5, 0.0625, 0.5, 1, 0, .03125, 0.8),
        Island::new
    )
        .withMinDistance(64)
        .withAltitude(70)
